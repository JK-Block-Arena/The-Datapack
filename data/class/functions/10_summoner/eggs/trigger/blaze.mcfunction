# 召唤
summon minecraft:blaze ^0.4 ^ ^ {PersistenceRequired:true,CustomName:'"神圣之火"',Health:20f,CustomNameVisible:true,Tags:["new_minion"]}
summon minecraft:blaze ^-0.4 ^ ^ {PersistenceRequired:true,CustomName:'"神圣之火"',Health:20f,CustomNameVisible:true,Tags:["new_minion"]}
# 设置玩家信息
...
# 减少存储
scoreboard players remove @s 10_blaze_st 1
# 刷新物品&打断回血
