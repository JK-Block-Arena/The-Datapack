...
execute as @s[team=red_v1] run summon item ~ ~2 ~ {id:"item",Item:{id:"red_banner",Count:1,tag:{BlockEntityTag:{Patterns:[{Pattern:"cre",Color:15}]}}},Age:-32768,PickupDelay:32767,Invulnerable:1b,NoGravity:1b,Glowing:1b,Tags:["new_minion","10_flag","10_flag_red_v1"]}
execute as @s[team=blue_v1] run summon item ~ ~2 ~ {id:"item",Item:{id:"blue_banner",Count:1,tag:{BlockEntityTag:{Patterns:[{Pattern:"cre",Color:15}]}}},Age:-32768,PickupDelay:32767,Invulnerable:1b,NoGravity:1b,Glowing:1b,Tags:["new_minion","10_flag","10_flag_blue_v1"]}
