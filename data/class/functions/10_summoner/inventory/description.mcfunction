...
execute if score $is_day mem matches 0 run item modify entity @s[tag=!detail] hotbar.2 class:10_summoner/2_night
execute if score $is_day mem matches 0 run item modify entity @s[tag=detail] hotbar.2 class:10_summoner/2_night_detail
execute if score $is_day mem matches 1 run item modify entity @s[tag=!detail] hotbar.2 class:10_summoner/2_day
execute if score $is_day mem matches 1 run item modify entity @s[tag=detail] hotbar.2 class:10_summoner/2_day_detail
