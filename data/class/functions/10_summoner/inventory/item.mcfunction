...
scoreboard players operation @s count1 = @s 10_zombie_st
scoreboard players operation @s cd1 = @s 10_zombie_cd
# 苦力怕
item replace entity @s[scores={10_creeper_st=1..},nbt=!{Inventory:[{Slot:2b,tag:{CustomModelData:1002}}]}] hotbar.2 with creeper_spawn_egg{CustomModelData:1002}
scoreboard players operation @s count2 = @s 10_creeper_st
scoreboard players operation @s cd2 = @s 10_creeper_cd
# 铁傀儡
item replace entity @s[scores={10_golem_st=1..},nbt=!{Inventory:[{Slot:3b,tag:{CustomModelData:1003}}]}] hotbar.3 with iron_golem_spawn_egg{CustomModelData:1003}
scoreboard players operation @s count3 = @s 10_golem_st
scoreboard players operation @s cd3 = @s 10_golem_cd
# 猪猪发射器
item replace entity @s[scores={10_pig_st=1..},nbt=!{Inventory:[{Slot:4b,tag:{CustomModelData:1004}}]}] hotbar.4 with pig_spawn_egg{CustomModelData:1004}
scoreboard players operation @s count4 = @s 10_pig_st
scoreboard players operation @s cd4 = @s 10_pig_cd
