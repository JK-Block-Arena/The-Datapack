...
# 显示提示
tellraw @s[scores={10_tip=1}] ["",{"text":"\n ⚜  小知识： ","color":"light_purple"},"召唤师只依靠魔法与生物攻击，近战只是顺手罢了。\n"]
...
tellraw @s[scores={10_tip=5}] ["",{"text":"\n ⚜  小知识： ","color":"light_purple"},"苦力怕如果运用得当，可以造成n连杀！\n"]
...
tellraw @s[scores={10_tip=8}] ["",{"text":"\n ⚜  小知识： ","color":"light_purple"},"“魔力值”这一概念只存在过一个小版本，现在只与冷却有关...\n"]
tellraw @s[scores={10_tip=9}] ["",{"text":"\n ⚜  小知识： ","color":"light_purple"},"猪猪能够在生成时即被乘坐多亏了 1.19.4 出的 /ride 指令！\n"]
tellraw @s[scores={10_tip=10}] ["",{"text":"\n ⚜  小知识： ","color":"light_purple"},"猪猪发射器使用后可能会造成无法静息，这是原版mc的bug...\n"]