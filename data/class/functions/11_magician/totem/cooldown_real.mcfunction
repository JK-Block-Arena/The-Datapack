...
scoreboard players add @s[scores={11_totem_cd=..0,11_totem_st=..1}] 11_totem_cd 60000
scoreboard players set @s[scores={11_totem_cd=..0,11_totem_st=2..}] 11_totem_cd 60000
