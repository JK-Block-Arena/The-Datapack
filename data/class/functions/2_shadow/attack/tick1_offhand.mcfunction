...
execute as @s[scores={2_pearl_storage=0}] run title @s actionbar [{"color":"red","text":"✖ "},{"text":"暗影精髓不足","bold":true}]
...
execute as @s[scores={2_pearl_storage=1..,2_attack_stack=..1}] run function class:2_shadow/attack/trigger
