...
execute if score $is_day mem matches 0 run scoreboard players set @s[scores={2_pearl_st=2}] 2_pearl_cd 12000
execute if score $is_day mem matches 1 run scoreboard players set @s[scores={2_pearl_st=2}] 2_pearl_cd 18000
