...
scoreboard players operation @s count0 = @s 2_pearl_st
scoreboard players operation @s cd0 = @s 2_pearl_cd
...
scoreboard players operation @s count8 = @s 2_sneak_st
scoreboard players operation @s cd8 = @s 2_sneak_cd
