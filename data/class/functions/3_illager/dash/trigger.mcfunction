...
execute if score @s 3_dash_last matches ..0 run playsound entity.ender_dragon.growl player @a ~ ~ ~ 0.8 1.7
execute if score @s 3_dash_last matches ..0 run playsound entity.ravager.stunned player @a ~ ~ ~ 1.5 0.6
