...
# 冷却完成
scoreboard players add @s[scores={3_jump_cd=..0}] 3_jump_st 1
scoreboard players add @s[scores={3_jump_cd=..0,3_jump_st=..1}] 3_jump_cd 20000
scoreboard players set @s[scores={3_jump_cd=..0,3_jump_st=2..}] 3_jump_cd 20000

# 检测刷新
tag @s[scores={3_jump_cd=..3099,3_jump_st=..0}] add refresh_inventory
