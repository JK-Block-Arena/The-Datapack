...
# 致盲
execute if entity @a[tag=owner,team=lobby] run effect give @e[type=vindicator,distance=..5] slowness 6 255
execute if entity @a[tag=owner,team=red,scores={statPlayerLevel=1}] run effect give @a[team=!red,distance=..6,gamemode=adventure] blindness 4
execute if entity @a[tag=owner,team=red,scores={statPlayerLevel=2..3}] run effect give @a[team=!red,distance=..5,gamemode=adventure] blindness 4
...
execute if entity @a[tag=owner,team=blue,scores={statPlayerLevel=1}] run effect give @a[team=!blue,distance=..6,gamemode=adventure] blindness 4
execute if entity @a[tag=owner,team=blue,scores={statPlayerLevel=2..3}] run effect give @a[team=!blue,distance=..5,gamemode=adventure] blindness 4
...
execute if entity @a[tag=owner,team=green,scores={statPlayerLevel=1}] run effect give @a[team=!green,distance=..6,gamemode=adventure] blindness 4
execute if entity @a[tag=owner,team=green,scores={statPlayerLevel=2..3}] run effect give @a[team=!green,distance=..5,gamemode=adventure] blindness 4
...
execute if entity @a[tag=owner,team=yellow,scores={statPlayerLevel=1}] run effect give @a[team=!yellow,distance=..6,gamemode=adventure] blindness 4
execute if entity @a[tag=owner,team=yellow,scores={statPlayerLevel=2..3}] run effect give @a[team=!yellow,distance=..5,gamemode=adventure] blindness 4
