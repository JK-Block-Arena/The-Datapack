...
execute if score @s statPlayerLevel matches 1 run playsound block.beacon.activate neutral @a[distance=..4] ~ ~ ~ 0.8 1.3
execute if score @s statPlayerLevel matches 2 run playsound block.beacon.activate neutral @a[distance=..5] ~ ~ ~ 0.8 1.3
execute if score @s statPlayerLevel matches 3 run playsound block.beacon.activate neutral @a[distance=..6] ~ ~ ~ 0.8 1.3
execute if score @s statPlayerLevel matches 4 run playsound block.beacon.activate neutral @a[distance=..7] ~ ~ ~ 0.8 1.3
