...
scoreboard players add @s[scores={4_water_cd=..0,4_water_storage=..1}] 4_water_cd 20000
scoreboard players set @s[scores={4_water_cd=..0,4_water_storage=2..}] 4_water_cd 20000
