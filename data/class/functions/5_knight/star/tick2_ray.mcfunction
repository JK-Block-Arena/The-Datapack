...
execute if score @s 5_star_last matches ..0 run playsound block.beacon.deactivate player @a ~ ~ ~ 0.3 1.5 0.001
execute if score @s 5_star_last matches ..0 as @a if score @s player_id = @e[tag=self,limit=1] player_id run playsound block.beacon.deactivate player @s ~ ~ ~ 0.3 1.5 0.3
