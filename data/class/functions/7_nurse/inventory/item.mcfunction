...
scoreboard players operation @s count2 = @s 7_damage_st
scoreboard players operation @s cd2 = @s 7_damage_cd
# 神圣
item replace entity @s[scores={7_heal_st=1..},nbt=!{Inventory:[{Slot:2b,tag:{CustomModelData:702}}]}] hotbar.2 with potion{CustomModelData:702,CustomPotionColor:14881233,Potion:"water",CustomPotionEffects:[{Id:6,Amplifier:1}]}
scoreboard players operation @s count3 = @s 7_heal_st
scoreboard players operation @s cd3 = @s 7_heal_cd
# 勇猛
item replace entity @s[scores={7_strength_st=1..},nbt=!{Inventory:[{Slot:3b,tag:{CustomModelData:703}}]}] hotbar.3 with potion{CustomModelData:703,CustomPotionColor:12132639,Potion:"water",CustomPotionEffects:[{Id:1,Amplifier:2,Duration:100}]}
scoreboard players operation @s count4 = @s 7_strength_st
scoreboard players operation @s cd4 = @s 7_strength_cd
# 保护
item replace entity @s[scores={7_turtle_st=1..},nbt=!{Inventory:[{Slot:4b,tag:{CustomModelData:704}}]}] hotbar.4 with potion{CustomModelData:704,CustomPotionColor:3657514,Potion:"water",CustomPotionEffects:[{Id:11,Amplifier:1,Duration:100}]}
scoreboard players operation @s count5 = @s 7_turtle_st
...
scoreboard players operation @s count9 = @s 7_eye_st
