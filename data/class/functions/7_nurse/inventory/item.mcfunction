...
item replace entity @s[scores={statPlayerLevel=4},nbt=!{Inventory:[{Slot:0b,tag:{CustomModelData:700}}]}] hotbar.0 with written_book{title:"创世纪第一章",author:"Nobody",pages:['[{"text":"书还没刷新呢，等会打开。"}]'],CustomModelData:700,Enchantments:[{id:"minecraft:knockback",lvl:0}],AttributeModifiers:[{Operation:0,Amount:-3.0,UUID:[I;7,0,1,1], AttributeName:"generic.attack_speed",Name:"generic.attackSpeed"},{Operation:0,Amount:2,UUID:[I;7,0,1,2],AttributeName:"generic.attack_damage",Name:"generic.attack"}],Unbreakable:1b,HideFlags:63}
scoreboard players set @s count1 -1
# 净化
item replace entity @s[scores={7_damage_storage=1..},nbt=!{Inventory:[{Slot:1b,tag:{CustomModelData:701}}]}] hotbar.1 with splash_potion{CustomModelData:701,CustomPotionColor:16777215,Potion:"water",CustomPotionEffects:[{Id:7,Amplifier:1},{Id:18,Amplifier:0,Duration:70},{Id:2,Amplifier:0,Duration:70},{Id:24,Amplifier:0,Duration:70}]}
scoreboard players operation @s count2 = @s 7_damage_storage
scoreboard players operation @s cd2 = @s 7_damage_cd
# 神圣
item replace entity @s[scores={7_heal_storage=1..},nbt=!{Inventory:[{Slot:2b,tag:{CustomModelData:702}}]}] hotbar.2 with potion{CustomModelData:702,CustomPotionColor:14881233,Potion:"water",CustomPotionEffects:[{Id:6,Amplifier:1}]}
scoreboard players operation @s count3 = @s 7_heal_storage
scoreboard players operation @s cd3 = @s 7_heal_cd
# 勇猛
item replace entity @s[scores={7_strength_storage=1..},nbt=!{Inventory:[{Slot:3b,tag:{CustomModelData:703}}]}] hotbar.3 with potion{CustomModelData:703,CustomPotionColor:12132639,Potion:"water",CustomPotionEffects:[{Id:1,Amplifier:2,Duration:100}]}
scoreboard players operation @s count4 = @s 7_strength_storage
scoreboard players operation @s cd4 = @s 7_strength_cd
# 保护
item replace entity @s[scores={7_turtle_storage=1..},nbt=!{Inventory:[{Slot:4b,tag:{CustomModelData:704}}]}] hotbar.4 with potion{CustomModelData:704,CustomPotionColor:3657514,Potion:"water",CustomPotionEffects:[{Id:11,Amplifier:1,Duration:100}]}
scoreboard players operation @s count5 = @s 7_turtle_storage
scoreboard players operation @s cd5 = @s 7_turtle_cd
# 支援
item replace entity @s[scores={7_eye_storage=1..},nbt=!{Inventory:[{Slot:8b,tag:{CustomModelData:705}}]}] hotbar.8 with ender_eye{CustomModelData:705}
scoreboard players operation @s count9 = @s 7_eye_storage
scoreboard players operation @s cd9 = @s 7_eye_cd
# 空格子
