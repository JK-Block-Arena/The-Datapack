...
execute if score $mutation mem matches 4 run scoreboard players add @s[scores={state=3,7_damage_cd=..0,7_damage_storage=..1}] 7_damage_cd 20000
execute if score $mutation mem matches 4 run scoreboard players set @s[scores={state=3,7_damage_cd=..0,7_damage_storage=2..}] 7_damage_cd 20000

execute if score $mutation mem matches 4 run scoreboard players add @s[scores={state=2,7_damage_cd=..0,7_damage_storage=..1}] 7_damage_cd 40000
execute if score $mutation mem matches 4 run scoreboard players set @s[scores={state=2,7_damage_cd=..0,7_damage_storage=2..}] 7_damage_cd 40000
