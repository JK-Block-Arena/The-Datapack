...
execute if score $mutation mem matches 4 run scoreboard players add @s[scores={state=3,7_heal_cd=..0,7_heal_storage=..1}] 7_heal_cd 15000
execute if score $mutation mem matches 4 run scoreboard players set @s[scores={state=3,7_heal_cd=..0,7_heal_storage=2..}] 7_heal_cd 15000

execute if score $mutation mem matches 4 run scoreboard players add @s[scores={state=2,7_heal_cd=..0,7_heal_storage=..1}] 7_heal_cd 30000
execute if score $mutation mem matches 4 run scoreboard players set @s[scores={state=2,7_heal_cd=..0,7_heal_storage=2..}] 7_heal_cd 30000
