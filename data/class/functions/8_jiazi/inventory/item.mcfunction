...
scoreboard players operation @s count1 = @s 8_pierce_st
scoreboard players operation @s cd1 = @s 8_pierce_cd
...
scoreboard players operation @s count2 = @s 8_wave_st
scoreboard players operation @s cd2 = @s 8_wave_cd
