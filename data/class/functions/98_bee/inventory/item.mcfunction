...
scoreboard players operation @s count2 = @s 98_bottle_st
scoreboard players operation @s cd2 = @s 98_bottle_cd
# 蜂蜜饯
...
scoreboard players operation @s count3 = @s 98_block_st
scoreboard players operation @s cd3 = @s 98_block_cd
# 空格子
