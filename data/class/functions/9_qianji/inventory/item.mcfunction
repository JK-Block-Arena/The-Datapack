...
scoreboard players operation @s count0 = @s 9_st1
scoreboard players operation @s cd0 = @s 9_cd1
...
scoreboard players operation @s count1 = @s 9_st2
scoreboard players operation @s cd1 = @s 9_cd2
...
scoreboard players operation @s count2 = @s 9_st3
scoreboard players operation @s cd2 = @s 9_cd3
...
scoreboard players operation @s count3 = @s 9_st4
scoreboard players operation @s cd3 = @s 9_cd4
...
scoreboard players operation @s count8 = @s 9_elytra_st
scoreboard players operation @s cd8 = @s 9_elytra_cd
