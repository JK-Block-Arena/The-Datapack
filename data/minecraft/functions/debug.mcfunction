...
execute if score $system_f3 debug matches 0 run summon marker ~ ~ ~ {CustomName:'{"text":"[F3 面板]","color":"gray"}',Tags:["display2"]}
execute if score $system_f3 debug matches 1 run summon marker ~ ~ ~ {CustomName:'{"text":"[F3 面板]","color":"green"}',Tags:["display2"]}
summon marker ~ ~ ~ {CustomName:'{"text":"[测试模式]","color":"white"}',Tags:["display3"]}
tellraw @s ["     系统  >>   ",{"selector":"@e[tag=display1]","clickEvent":{"action":"run_command","value":"/function debug:trigger/system_init"}},"  ",{"selector":"@e[tag=display2]","clickEvent":{"action":"run_command","value":"/function debug:trigger/system_f3"}},"  ",{"selector":"@e[tag=display3]","clickEvent":{"action":"run_command","value":"/function debug:jkuse/debug"}}]
kill @e[tag=display1]
kill @e[tag=display2]
kill @e[tag=display3]
...
tellraw @s ["     战斗  >>   ",{"selector":"@e[tag=display1]","clickEvent":{"action":"run_command","value":"/function debug:trigger/skill_cd"}},"  ",{"selector":"@e[tag=display2]","clickEvent":{"action":"run_command","value":"/function debug:trigger/skill_heal"}},"  ",{"selector":"@e[tag=display3]","clickEvent":{"action":"run_command","value":"/function debug:trigger/skill_respawn"}}]
#,"  ",{"selector":"@e[tag=display4]","clickEvent":{"action":"run_command","value":"/function debug:trigger/skill_friendly_fire"},"hoverEvent": {"action":"show_text","value":"杀戮光环突变时请不要使用"}}
kill @e[tag=display1]
kill @e[tag=display2]
kill @e[tag=display3]
kill @e[tag=display4]
# 统计
summon marker ~ ~ ~ {CustomName:'{"text":"[打印全职业数据]","color":"white"}',Tags:["display1"]}
summon marker ~ ~ ~ {CustomName:'{"text":"[重置]","color":"white"}',Tags:["display2"]}
summon marker ~ ~ ~ {CustomName:'{"text":"[重置本月数据]","color":"white"}',Tags:["display5"]}
...
#"  ",{"selector":"@e[tag=display3]","clickEvent":{"action":"run_command","value":"/function debug:trigger/stat_condition"}},"  ",{"selector":"@e[tag=display4]","clickEvent":{"action":"run_command","value":"/function debug:trigger/stat_elo"}},
tellraw @s ["     统计  >>   ",{"selector":"@e[tag=display1]","clickEvent":{"action":"run_command","value":"/function modules:stat/sub/print"}},"  ",{"selector":"@e[tag=display2]","clickEvent":{"action":"run_command","value":"/function modules:stat/sub/reset"}},"  ",{"selector":"@e[tag=display5]","clickEvent":{"action":"run_command","value":"/function modules:stat/sub/monthly_reset"}}]
kill @e[tag=display1]
kill @e[tag=display2]
#kill @e[tag=display3]
#kill @e[tag=display4]
...
#{"selector":"@e[tag=display1]","clickEvent":{"action":"run_command","value":"/function debug:trigger/info_tip_hide"}},"  ",,"  ",{"selector":"@e[tag=display4]","clickEvent":{"action":"run_command","value":"/function debug:trigger/info_refresh_inv"}}
tellraw @s ["     信息  >>   ",{"selector":"@e[tag=display2]","clickEvent":{"action":"run_command","value":"/function debug:trigger/info_hud"}},"  ",{"selector":"@e[tag=display3]","clickEvent":{"action":"run_command","value":"/function debug:trigger/info_ignore_afk"}}]
#kill @e[tag=display1]
kill @e[tag=display2]
kill @e[tag=display3]
#kill @e[tag=display4]
...
execute if score $map mem matches 3 run summon marker ~ ~ ~ {CustomName:'{"text":"[沙滩]","color":"green"}',Tags:["display3"]}
execute unless score $map mem matches 3 run summon marker ~ ~ ~ {CustomName:'{"text":"[沙滩]","color":"gray"}',Tags:["display3"]}
execute if score $map mem matches 4 run summon marker ~ ~ ~ {CustomName:'{"text":"[瀑布]","color":"green"}',Tags:["display4"]}
execute unless score $map mem matches 4 run summon marker ~ ~ ~ {CustomName:'{"text":"[瀑布]","color":"gray"}',Tags:["display4"]}
execute if score $map mem matches 5 run summon marker ~ ~ ~ {CustomName:'{"text":"[丛林]","color":"green"}',Tags:["display5"]}
execute unless score $map mem matches 5 run summon marker ~ ~ ~ {CustomName:'{"text":"[丛林]","color":"gray"}',Tags:["display5"]}
execute if score $map mem matches 6 run summon marker ~ ~ ~ {CustomName:'{"text":"[古堡]","color":"green"}',Tags:["display6"]}
execute unless score $map mem matches 6 run summon marker ~ ~ ~ {CustomName:'{"text":"[古堡]","color":"gray"}',Tags:["display6"]}
execute if score $map mem matches 7 run summon marker ~ ~ ~ {CustomName:'{"text":"[商店]","color":"green"}',Tags:["display7"]}
execute unless score $map mem matches 7 run summon marker ~ ~ ~ {CustomName:'{"text":"[商店]","color":"gray"}',Tags:["display7"]}
execute if score $map mem matches 8 run summon marker ~ ~ ~ {CustomName:'{"text":"[舞台]","color":"green"}',Tags:["display8"]}
execute unless score $map mem matches 8 run summon marker ~ ~ ~ {CustomName:'{"text":"[舞台]","color":"gray"}',Tags:["display8"]}
execute if score $map mem matches 9 run summon marker ~ ~ ~ {CustomName:'{"text":"[矿洞]","color":"green"}',Tags:["display9"]}
execute unless score $map mem matches 9 run summon marker ~ ~ ~ {CustomName:'{"text":"[矿洞]","color":"gray"}',Tags:["display9"]}
execute if score $map mem matches 100 run summon marker ~ ~ ~ {CustomName:'{"text":"[玄素]","color":"green"}',Tags:["display100"]}
execute unless score $map mem matches 100 run summon marker ~ ~ ~ {CustomName:'{"text":"[玄素]","color":"black"}',Tags:["display100"]}
tellraw @s ["     切换战场  >>   ",{"selector":"@e[tag=display1]","clickEvent":{"action":"run_command","value":"/function debug:trigger/map_change_1"}},"  ",{"selector":"@e[tag=display2]","clickEvent":{"action":"run_command","value":"/function debug:trigger/map_change_2"}},"  ",{"selector":"@e[tag=display3]","clickEvent":{"action":"run_command","value":"/function debug:trigger/map_change_3"}},"  ",{"selector":"@e[tag=display4]","clickEvent":{"action":"run_command","value":"/function debug:trigger/map_change_4"}},"  ",{"selector":"@e[tag=display5]","clickEvent":{"action":"run_command","value":"/function debug:trigger/map_change_5"}},"  ",{"selector":"@e[tag=display6]","clickEvent":{"action":"run_command","value":"/function debug:trigger/map_change_6"}},"  ",{"selector":"@e[tag=display7]","clickEvent":{"action":"run_command","value":"/function debug:trigger/map_change_7"}},"  ",{"selector":"@e[tag=display8]","clickEvent":{"action":"run_command","value":"/function debug:trigger/map_change_8"}},"  ",{"selector":"@e[tag=display9]","clickEvent":{"action":"run_command","value":"/function debug:trigger/map_change_9"}},"  ",{"selector":"@e[tag=display100]","clickEvent":{"action":"run_command","value":"/function debug:trigger/map_change_100"}}]
