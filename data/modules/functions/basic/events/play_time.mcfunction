...
scoreboard players reset @s[scores={play_time_trigger=2..}] play_time_trigger
...
title @s actionbar [{"text":"你本月在线时长为：","color":"yellow","bold":true},{"score":{"name":"@s","objective":"play_time_d"},"color":"gold"},"天",{"score":{"name":"@s","objective":"play_time_h"},"color":"gold"},"时",{"score":{"name":"@s","objective":"play_time_m"},"color":"gold"},"分",{"score":{"name":"@s","objective":"play_time_s"},"color":"gold"},"秒"]
