...
# 在线时长
scoreboard objectives remove play_time_trigger
scoreboard objectives add play_time_trigger trigger "开启/关闭在线时长显示"
...
#scoreboard objectives add play_time dummy "本月在线时长"
