...
execute as @a[scores={state=0..2,tip_0_tutorial=7..}] at @s run playsound entity.ender_dragon.growl player @s 0 1000000 0 1000000
scoreboard players add @a[scores={state=1..2,tip_0_tutorial=7..}] MstatPlayerRound 1
