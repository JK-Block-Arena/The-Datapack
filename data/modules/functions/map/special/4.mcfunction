...
execute positioned 7049.5 32.5 6973.5 run effect give @p[distance=...8,gamemode=adventure] minecraft:speed 5 10
...
execute positioned 7046.5 35.5 6919.5 run effect give @p[distance=...8,gamemode=adventure] minecraft:speed 5 10
...
execute positioned 7066.5 40.5 6983.5 run effect give @p[distance=...8,gamemode=adventure] minecraft:jump_boost 1 8
