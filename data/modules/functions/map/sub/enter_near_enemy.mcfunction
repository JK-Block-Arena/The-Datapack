...
execute unless entity @e[tag=random_point] as @s[team=blue] as @e[tag=select_point] at @s unless entity @a[team=!blue,scores={state=2},distance=..15] unless entity @e[team=!blue,distance=..6,type=#modules:living,type=!player] run tag @s add random_point
execute unless entity @e[tag=random_point] as @s[team=green] as @e[tag=select_point] at @s unless entity @a[team=!green,scores={state=2},distance=..15] unless entity @e[team=!green,distance=..6,type=#modules:living,type=!player] run tag @s add random_point
execute unless entity @e[tag=random_point] as @s[team=yellow] as @e[tag=select_point] at @s unless entity @a[team=!yellow,scores={state=2},distance=..15] unless entity @e[team=!yellow,distance=..6,type=#modules:living,type=!player] run tag @s add random_point
