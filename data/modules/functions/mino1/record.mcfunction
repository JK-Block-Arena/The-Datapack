...
execute if score $mutation mem matches 9 if score #9_select mem matches 5 if score #9_time mem matches 1.. run tag @s[scores={team=1..4}] add 9_select_fail_1
execute if score $mutation mem matches 9 if score #9_select mem matches 8 if score #9_time mem matches 1.. run tag @a[tag=mino_murder,scores={team=1..4}] add 9_select_success_1
