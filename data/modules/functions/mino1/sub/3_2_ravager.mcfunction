...
execute as @s[team=red_v1] as @e[type=ravager,team=!red_v1,sort=nearest,limit=1] at @s run function modules:mino1/sub/murder
execute as @s[team=blue_v1] as @e[type=ravager,team=!blue_v1,sort=nearest,limit=1] at @s run function modules:mino1/sub/murder