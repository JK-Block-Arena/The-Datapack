...
execute at @s anchored eyes run particle dust 10 0 0 1.2 ^ ^ ^0.2 0.35 0.35 0.35 0 20 normal @s
...
execute as @p[tag=mino_murder] at @s anchored eyes run particle dust 10 0 0 1.2 ^ ^ ^0.2 0.35 0.35 0.35 0 20 normal @s