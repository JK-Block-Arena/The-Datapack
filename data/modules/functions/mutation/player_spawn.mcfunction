...
execute unless score $mutation mem matches 1 unless score $mutation mem matches 6 as @a[scores={state=2,team=1..4}] run attribute @s minecraft:generic.max_health base set 20