...
execute if entity @p[tag=9_select_success] run tellraw @a[scores={state=1..2}] [{"text":" ❇  ","color":"green"},{"selector":"@a[tag=9_select_success]"}," 是合格的木头人！"]
execute if entity @p[tag=9_select_fail] run tellraw @a[scores={state=1..2}] [{"text":" ❇  ","color":"red"},{"selector":"@a[tag=9_select_fail]"}," 根本停不下来！"]
