...
execute if score $mutation mem matches 11 run function modules:mutation/special/11_tick16
# 心跳特效
...
execute as @a[scores={heartbeat=2,state=2,team=1..4,hp=1..4}] run playsound block.conduit.ambient player @s 0 1000000 0 1000000 1.67
