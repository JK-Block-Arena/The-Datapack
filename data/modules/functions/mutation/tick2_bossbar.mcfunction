...
# 提示
execute if score #mutation mem matches 9200.. if score $mutation_warn mem matches 0 run playsound minecraft:block.note_block.chime player @a[scores={state=1..2}] 0 1000000 0 1000000 0.7
execute if score #mutation mem matches 9200.. if score $mutation_warn mem matches 0 run title @a[scores={state=1..2}] actionbar {"color":"gold","text":"⚠ 突变效果即将触发","bold": true}
