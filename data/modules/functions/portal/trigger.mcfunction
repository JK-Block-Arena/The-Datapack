...
execute if score #portal mem matches 101 run tp @s 1043.5 112.5 1089.5 180 0
execute if score #portal mem matches 102 run tp @s -3.5 -6.5 9.5 270 0
...
# 特效
execute at @s run playsound block.portal.travel block @s ~ ~ ~ 0.3
