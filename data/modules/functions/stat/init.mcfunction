...
# 月玩家统计
scoreboard objectives add MstatPlayerRound dummy "本月玩家总循环"
scoreboard objectives add MstatPlayerKill dummy "本月玩家总击杀"
scoreboard objectives add MstatPlayerDeath dummy "本月玩家总死亡"
scoreboard objectives add MstatPlayerKD dummy "本月玩家K/D * 1k值"

scoreboard objectives modify MstatPlayerClassKill1 displayname "本月游侠击杀"
scoreboard objectives modify MstatPlayerClassKill2 displayname "本月暗影击杀"
scoreboard objectives modify MstatPlayerClassKill3 displayname "本月突袭者击杀"
scoreboard objectives modify MstatPlayerClassKill4 displayname "本月海嗣击杀"
scoreboard objectives modify MstatPlayerClassKill5 displayname "本月耀骑士击杀"
scoreboard objectives modify MstatPlayerClassKill6 displayname "本月有用之人击杀"
scoreboard objectives modify MstatPlayerClassKill7 displayname "本月牧师击杀"
scoreboard objectives modify MstatPlayerClassKill8 displayname "本月夹子击杀"
scoreboard objectives modify MstatPlayerClassKill9 displayname "本月千机击杀"
scoreboard objectives modify MstatPlayerClassKill10 displayname "本月召唤师击杀"
scoreboard objectives modify MstatPlayerClassKill11 displayname "本月魔术师击杀"