...
execute if score $is_day mem matches 1 run playsound ui.toast.challenge_complete player @a 0 1000000 0 1 0.6 0.6

# 进入夜晚
execute if score $is_day mem matches 0 run tellraw @a[tag=pass] [{"text":" ❇ ","color":"aqua"}," 夜幕已经降临……"]
execute if score $is_day mem matches 0 run playsound entity.elder_guardian.curse player @a 0 1000000 0 1 0 0.6
