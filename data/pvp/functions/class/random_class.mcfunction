...
execute unless score #match_mode mem matches 1 at @s[scores={class=3,class_type=0}] run summon marker ~ ~ ~ {Tags:["current_class"],CustomName:'[{"text":"突袭者","color":"aqua","bold":true}]'}
execute if score #match_mode mem matches 1 at @s[scores={class=3,class_type=0}] run summon marker ~ ~ ~ {Tags:["current_class"],CustomName:'[{"text":"突袭者 · 新版","color":"aqua","bold":true}]'}
