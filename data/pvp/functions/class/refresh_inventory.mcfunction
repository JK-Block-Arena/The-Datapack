...
execute if entity @e[limit=1,tag=class8,tag=banned_class] run item replace entity @s container.30 from block 6 244 22 container.26
...
execute if entity @e[limit=1,tag=class3,tag=!banned_class] unless score @s class matches 3 run item replace entity @s hotbar.3 from block 6 245 22 container.0
execute if entity @e[limit=1,tag=class3,tag=!banned_class] if score @s[scores={class_type=0}] class matches 3 run item replace entity @s hotbar.3 from block 6 245 22 container.1
execute if entity @e[limit=1,tag=class3,tag=!banned_class] if score @s[scores={class_type=1}] class matches 3 run item replace entity @s hotbar.3 from block 6 245 22 container.2
...
execute if entity @e[limit=1,tag=class8,tag=!banned_class] unless score @s class matches 8 run item replace entity @s container.30 from block 6 244 22 container.0
execute if entity @e[limit=1,tag=class8,tag=!banned_class] if score @s class matches 8 run item replace entity @s container.30 from block 6 244 22 container.1
