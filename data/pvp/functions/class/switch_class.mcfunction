...
execute if entity @e[limit=1,tag=class3,tag=!banned_class] run scoreboard players set @s[nbt=!{Inventory:[{Slot:3b}]}] class 3
...
execute if entity @e[limit=1,tag=class8,tag=!banned_class] run scoreboard players set @s[nbt=!{Inventory:[{Slot:30b}]}] class 8
...
scoreboard players set @s[nbt=!{Inventory:[{Slot:8b}]}] class 10000
