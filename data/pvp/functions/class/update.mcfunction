...
data merge entity @e[tag=class11,tag=!banned_class,limit=1] {CustomName:'{"text":"魔术师","color":"green"}'}
...
data merge entity @e[tag=class11,tag=banned_class,limit=1] {CustomName:'{"text":"魔术师","color":"red"}'}