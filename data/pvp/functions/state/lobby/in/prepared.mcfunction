...
execute as @s[scores={team_prefer=5}] run function pvp:state/lobby/in/team_1v1
...
execute as @s[scores={team=1..}] run tellraw @a[distance=0.01..,scores={state=0..2}] ["",{"text":" ❇  "},{"selector":"@s"}," 加入了战场"]