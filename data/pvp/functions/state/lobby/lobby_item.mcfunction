...
summon text_display 8.5 237.5 8.5 {Tags:["lobby_item"],text:'{"text":"⚕ 魔改·方块竞技场 v2.10.2 ⚕","color":"gold","bold":true}',background:0,billboard:"center",line_width:200,interpolation_duration:0,transformation:{scale:[1f,1f,1f],translation:[0f,0f,0f],right_rotation:[0f,0f,0f,1f],left_rotation:[0f,0f,0f,1f]}}
