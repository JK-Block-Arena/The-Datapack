...
# 禁止无rick成就者观看rick
execute as @s[advancements={pvp:rickroll/rick5=false},x=8,y=300,z=8,distance=..20] run tellraw @s {"text": "你干嘛~哈哈哈~哎哟~","color": "yellow"}
execute as @s[advancements={pvp:rickroll/rick5=false},x=8,y=300,z=8,distance=..20] run playsound entity.chicken.ambient player @s
execute as @s[advancements={pvp:rickroll/rick5=false},x=8,y=300,z=8,distance=..20] run function debug:jkuse/1_back_spawn
...
execute if block ~ ~-1 ~ diamond_block run effect give @s[gamemode=adventure,x=-888,y=38,z=8,distance=..50] minecraft:speed 1 4 true
