...
# 选职业物品
execute unless score $mutation mem matches 2 unless score $mutation mem matches 11 run function pvp:class/refresh_inventory
execute if score $mutation mem matches 2 run function pvp:class/refresh_inventory2
execute if score $mutation mem matches 11 run function pvp:class/refresh_inventory2
