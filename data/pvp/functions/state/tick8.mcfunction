...
execute unless score $mutation mem matches 10 as @a[gamemode=adventure,scores={tip_0_tutorial=7..}] at @s unless score @s class matches 1..10 run function modules:mutation/special/2_trigger